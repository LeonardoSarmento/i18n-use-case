...
export function NavigationBar() {
  ...
  return (
    <div className="flex w-full flex-wrap-reverse items-center gap-4 p-2 sm:my-2 md:flex-nowrap xl:gap-2 xl:space-x-7">
      <div className="md:flex w-full justify-center hidden md:order-first xl:w-1/3 xl:justify-start">
        <a href="https://github.com/LeonardoSarmento/i18n-use-case" target="_blank" rel="noopener noreferrer">
          <Button variant="ghost" className="gap-3">
            <Github />
            <p className="text-base underline underline-offset-4">i18n-use-case</p>
          </Button>
        </a>
      </div>
